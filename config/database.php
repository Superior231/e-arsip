    ...
    */
    ...
    'connections' => [
        ...
        'mysql_earsip' => [
            'driver' => 'mysql',
            'url' => env('DB_URL'),
            'host' => env('DB_EARSIP_HOST', '127.0.0.1'),
            'port' => env('DB_EARSIP_PORT', '3306'),
            'database' => env('DB_EARSIP_DATABASE', 'laravel'),
            'username' => env('DB_EARSIP_USERNAME', 'root'),
            'password' => env('DB_EARSIP_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => env('DB_CHARSET', 'utf8mb4'),
            'collation' => env('DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
